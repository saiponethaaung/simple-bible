...
import 'package:simple_bible/provider/verse_builder.dart';
...
class _ParagraphBuilderState extends State<ParagraphBuilder> {
  ...
  Widget build(BuildContext context) {
    ...
    //TODO: Color accentTextColor = FluentTheme.of(context).accentColor;
    Color accentTextColor = Colors.indigo;
...
//1Ki 1.50 - see paired usfm inside \f...\f* ndeysaan
    ...
    List<InlineSpan> normalVerseFragment(ParsedLine line,
      ...
      bool? textSpanUnderline =
          widget.rangeOfVersesToCopy.any((ParsedLine element) =>
    ...
    for (var line in widget.paragraph) {
      ...
      switch (line.verseStyle) {
        case 'v':
          ...
          styledParagraphFragments.addAll([const TextSpan(text: "\n\n\n")]);
          header = false;
          break;
